      ...
      <Grid container spacing={3} alignItems='center'>
        ...
        <Grid item sm={8}>
          ...
          <h4>
            ...
            learned everything from basic HTML and CSS to JavaScript, jQuery and
            CSS applications such as BootStrap and MaterialUI. For the backend,
            I have learned Node, express, axios as well as databases in MySql
            and MongoDb.
          </h4>
          <h4>
            My passions are with React as well as Node. I enjoy putting an
            entire project start to finish working with Node, a database (MySql,
            Firebase, and MongoDb) I have recently completed a 30+ hour project
            social media application I called RambleSpace, modeled after
            Twitter. It is a fully functioning social media site that helped me
            really understand and learn every part of React.
          </h4>
          <h4>
            While I am very new and very "green" in my new role, I will bring a
            passion and dedication to your organization to have you not
